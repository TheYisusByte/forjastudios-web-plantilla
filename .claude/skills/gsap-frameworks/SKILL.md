...
description: Official GSAP skill for Vue, Svelte, Nuxt, and other component frameworks — lifecycle, gsap.context(), cleanup on unmount, scoping selectors. Use when the user wants GSAP animation in Vue, Svelte, Nuxt, or SvelteKit.
license: MIT
---
